...
do
  qsub -N "setspacing-$img" -o $OUTPUTDIR -e $ERRORDIR getspacing.qsub.sh $img $INPUTPATH $OUTPUTPATH $REFIMG
done
qblock
...
$C3DDIR/c3d $MRILABEL_INDIR/${MRILABEL_INNAME}.nii.gz -thresh 1 inf 1 0 -o $MRIMASK_OUTDIR/${MRIMASK_OUTNAME}_oriented.nii.gz
