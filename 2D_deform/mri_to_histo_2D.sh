...
HISTO_SLICEPATH="$H2MDIR/iter${H2M_NITER}/reslice"
HISTOMASK_SLICEPATH="$H2MDIR/iter${H2M_NITER}/reslice/mask"
HISTO_SLICENAME="inplane_H2M_slice"
HISTOMASK_SLICENAME="inplane_H2M_mask_slice"
MRI_SLICEPATH="$M2HDIR/iter${H2M_NITER}/slices"
MRILABEL_SLICEPATH="$M2HDIR/iter${H2M_NITER}/slices/label"
MRI_SLICENAME="affine_MRI_to_histo_iter${H2M_NITER}_slice"
MRILABEL_SLICENAME="affine_MRI_to_histo_iter${H2M_NITER}_label_slice"
TRG_SLICEPATH="$DEFORMDIR/reslice"
TRGLABEL_SLICEPATH="$DEFORMDIR/reslice/label"
TXPATH="$DEFORMDIR/tx"
